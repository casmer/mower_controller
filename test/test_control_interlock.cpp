...
TEST(control_interlock, initialize)
{
...
TEST(control_interlock, disengaged)
{
    ...
    bool expected_interlock_a = false;
    bool expected_interlock_input = true;
    ...
    for (int i = 0; i < ControlInterlock::kInterlockBufferSize; i++)
    {
        ...
        EXPECT_CALL(interlock_a, read()).Times(1).WillOnce(testing::Return(expected_interlock_input));
        EXPECT_CALL(interlock_b, read()).Times(1).WillOnce(testing::Return(expected_interlock_input));
...
TEST(control_interlock, disengaged_bad_signal_b)
{
    ...
    bool expected_interlock_a = false;
    bool expected_interlock_input = false;
...
TEST(control_interlock, disengaged_bad_signal_a)
{
...
TEST(control_interlock, disengaged_bad_signal_ab)
{
